...
vjs.plugin('vastClient', function VASTPlugin(options) {
  ...
  function tryToPlayPrerollAd() {
    ...
    playerUtils.once(player, ['vast.skipAd', 'vast.adsCancel', 'vast.adEnd'], function () {
      removeAdUnit();
      restoreVideoContent();
    });
...
VASTIntegrator.prototype._setupEvents = function setupEvents(adMediaFile, tracker, response, callback) {
  ...
  playerUtils.once(player, ['vast.adEnd'], unbindEvents);
  playerUtils.once(player, ['vast.skipAd'], unTrackAll);
...
VASTIntegrator.prototype._addSkipButton = function addSkipButton(source, tracker, response, callback) {
  ...
  function addSkipButtonToPlayer(player, skipOffset) {
    ...
    playerUtils.once(player, ['vast.skipAd','ended', 'error'], removeSkipButton);
  ...
  function createSkipButton(player) {
    ...
    skipButton.onclick = function (e) {
      if (dom.hasClass(skipButton, 'enabled')) {
        tracker.trackSkip();        
        player.trigger('vast.skipAd');//We trigger the end of the ad playing        
      }
...
VASTIntegrator.prototype._addClickThrough = function addClickThrough(mediaFile, tracker, response, callback) {
  ...
  playerUtils.once(player, ['vast.skipAd','ended', 'error'], removeBlocker);
