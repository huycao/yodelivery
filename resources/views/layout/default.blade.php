...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        {{ HTML::style("{$assetURL}css/normalize.css") }}
        {{ HTML::style("{$assetURL}css/main.css") }}
        {{ HTML::style("{$assetURL}css/bootstrapValidator.min.css") }}
    ...
    <body>
        ...
        {{ HTML::script("{$assetURL}js/bootstrapValidator.min.js") }}
